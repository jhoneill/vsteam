...
Describe 'VSTeamWorkItemPageGroup' {
   ...
   Context 'Add-VSTeamWorkItemPageGroup' {

      It 'should call Get-WorkitemType, unlock the WIT, and call the POST Rest API with the right body.' {
         ## Act
         $wipg =Add-VSTeamWorkItemPageGroup -ProcessTemplate Scrum5 -WorkItemType Change* -PageLabel Details -SectionID Section2 -Order 0 -label "NewGroup"  -force
         ...
         Should -Invoke _callapi -Scope It -parameterFilter {
               ...
               $url    -like   '*.Details/sections/Section2/Groups*' -and
               $body    -match '"label":\s*"NewGroup"' -and
               $body    -match '"Order":\s*0' -and
         ...
         $wipg.SectionID         | should -BeExactly 'Section2'
      }
   }
}